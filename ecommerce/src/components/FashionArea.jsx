...
export const FashionArea = () => {
    ...
    return (
        <div className="flex flex-col justify-center align-items-center h-100" style={divStyle}>
            <div className="flex flex-col max-w-screen-xl mx-auto gap-12 text-center">
                <h2 className="text-5xl font-bold text-white leading-normal"><span className="font-normal">Smart Fashion</span><br/>With Smart Devices </h2>
                <button type="button"
