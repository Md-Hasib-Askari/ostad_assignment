...
export const Privacy = () => {
  return (
    <>
      <Header />
      <Heading pageTitle={"Privacy"} />
      <div className="max-w-screen-xl leading-loose py-20 px-4 mx-auto format dark:format-invert lg:px-4">
        ...
        <p>
          ...
          services (the "Services", which include the Website ), we appreciate
        ...
        <h2 className="my-4 font-medium">TABLE OF CONTENTS</h2>
        <ol className="pl-10 py-3 list-decimal">
          <li>
            <a
              className="text-blue-600 no-underline dark:text-blue-400 hover:underline"
              href="#1"
        ...
        <p>
          ...
          names; email addresses; passwords; and other similar information.
        </p>
        <p>
        ...
        <p>
          Bergisde Inc. has not disclosed or sold any personal information to
          third parties for a business or commercial purpose in the preceding 12
          months. Bergside Inc. will not sell personal information in the future
