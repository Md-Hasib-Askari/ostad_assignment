...
export const TOS = () => {
  return (
    <>
      <Header />
      <Heading pageTitle={"Terms and conditions"} />
      <div className="max-w-screen-xl leading-loose py-20 px-4 mx-auto lg:px-4 format dark:format-invert">
        <h1 className="mb-6 text-3xl font-bold text-gray-900 lg:text-4xl dark:text-white">
        ...
        <p>
          ...
          for the following goods, products, and/or services: website themes and
          templates (the "Marketplace Offerings"). In order to help make the
          ...
          Terms of Use. You agree that by accessing the Site and/or the
        ...
        <p>
          ...
          these Terms of Use, no part of the Site or the Marketplace Offerings
        ...
        <h2 className="mb-4">USER REPRESENTATIONS</h2>
        <p>
          <strong>
          ...
          reside; (3) you will not access the Site or the Marketplace Offerings
          through automated or non-human means, whether through a bot, script or
          otherwise; (4) you will not use the Site for any illegal or
          unauthorized purpose; and (5) your use of the Site or the Marketplace
        ...
        <p>
          ...
          Offerings, violate any laws. Among unauthorized Marketplace Offerings
          are the following: intoxicants of any sort; illegal drugs or other
          illegal products; alcoholic beverages; games of chance; and
          pornography or graphic adult content, images, or other adult products.
          Postings of any unauthorized products or content may result in
          immediate termination of your account and a lifetime ban from use of
          the Site.
        </p>
        <p>
        ...
        <h2 className="mb-4">MARKETPLACE OFFERINGS</h2>
        <p>
          <strong>
            ...
            the colors, features, specifications, and details of the Marketplace
            Offerings will be accurate, complete, reliable, current, or free of
            other errors, and your electronic display may not accurately reflect
            the actual colors and details of the products. All Marketplace
            Offerings are subject to availability
          </strong>
        ...
        <h2 className="mb-4">PURCHASES AND PAYMENT</h2>
        ...
        <p>
          ...
          any time. All payments shall be in the currencies available in the
        ...
        <h2 className="mb-4">PROHIBITED ACTIVITIES</h2>
        <p>
          <strong>
        ...
        <h2 className="mb-4">USER GENERATED CONTRIBUTIONS</h2>
        <p>
          <strong>
        ...
        <h2 className="mb-4">CONTRIBUTION LICENSE</h2>
        <p>
        ...
        <h2 className="mb-4">SITE MANAGEMENT</h2>
        <p>
        ...
        <h2 className="mb-4">TERM AND TERMINATION</h2>
        <p>
        ...
        <p>
          ...
          Marketplace Offerings; (2) breach of these Terms of Use; (3) any
