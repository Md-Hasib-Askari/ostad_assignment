...
const Cart = async (req) => {
    try {
        ...
        let joinStageProduct = {$lookup: {from: "Product", localField: "productID", foreignField: "_id", as: "product"}};
        let unwindProductStage = {$unwind: "$product"}

        let joinStageBrand = {$lookup: {from: "Brand", localField: "product.brandID", foreignField: "_id", as: "brand"}};
        let unwindBrandStage = {$unwind: "$brand"}

        let joinStageCategory = {$lookup: {from: "Category", localField: "product.categoryID", foreignField: "_id", as: "category"}};
